...
typedef union {
    ...
    uint8_t  b[16];
    int8_t   sb[16];
    uint32_t   f[4]; //float32
    uint64_t   d[2]; //float64
    float f2[4];
    double d2[2];
} SSE_REG;
...
#define CPU_FEATURE_MONITOR_MWAIT (1 << 16)
...
extern void exec386_2386(int64_t cycs);
extern void exec386(int64_t cycs);
extern void exec386_dynarec(int64_t cycs);
