...
static char      target_xml[]   = /* QEMU gdb-xml/i386-32bit.xml with modifications (described in comments) */
    ...
    "<target>"
        ...
        "<feature name=\"org.gnu.gdb.i386.core\">"
            ...
            "<vector id=\"v2u64\" type=\"uint64\" count=\"2\"/>"
            "<union id=\"xmm\">"
            ...
            "</flags>"
            ""
            "<reg name=\"xmm0\" bitsize=\"128\" type=\"xmm\" group=\"sse\"/>"
            "<reg name=\"xmm1\" bitsize=\"128\" type=\"xmm\" group=\"sse\"/>"
            "<reg name=\"xmm2\" bitsize=\"128\" type=\"xmm\" group=\"sse\"/>"
            "<reg name=\"xmm3\" bitsize=\"128\" type=\"xmm\" group=\"sse\"/>"
            "<reg name=\"xmm4\" bitsize=\"128\" type=\"xmm\" group=\"sse\"/>"
            "<reg name=\"xmm5\" bitsize=\"128\" type=\"xmm\" group=\"sse\"/>"
            "<reg name=\"xmm6\" bitsize=\"128\" type=\"xmm\" group=\"sse\"/>"
            "<reg name=\"xmm7\" bitsize=\"128\" type=\"xmm\" group=\"sse\"/>"
            ""
            "<reg name=\"mxcsr\" bitsize=\"32\" type=\"i386_mxcsr\" group=\"sse\"/>"
        "</feature>"
    "</target>";
// clang-format on
...
gdbstub_client_write_reg(int index, uint8_t *buf)
{
    ...
    switch (index) {
        ...
        case GDB_REG_XMM0 ... GDB_REG_XMM7:
            width                          = 16;
            cpu_state.XMM[index - GDB_REG_XMM0].q[0] = *((uint64_t *) &buf[0]);
            cpu_state.XMM[index - GDB_REG_XMM0].q[1] = *((uint64_t *) &buf[8]);
            break;

        case GDB_REG_MXCSR:
            cpu_state.mxcsr = *((uint32_t *) buf);
            break;
...
gdbstub_client_read_reg(int index, uint8_t *buf)
{
    ...
    switch (index) {
        ...
        case GDB_REG_XMM0 ... GDB_REG_XMM7:
            width                   = 16;
            *((uint64_t *) &buf[0]) = cpu_state.XMM[index - GDB_REG_XMM0].q[0];
            *((uint64_t *) &buf[8]) = cpu_state.XMM[index - GDB_REG_XMM0].q[1];
            break;

        case GDB_REG_MXCSR:
            *((uint32_t *) buf) = cpu_state.mxcsr;
            break;
