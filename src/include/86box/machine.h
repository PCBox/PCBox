...
#define MACHINE_COREBOOT         0x100000000ULL /* sys has coreboot BIOS */
/* Feature flag for SMP (Symmetric Multiprocessing) support.
   Uses bit 32+ of the uintptr_t flags field (safe on 64-bit platforms). */
#define MACHINE_SMP 0x200000000ULL /* machine supports dual CPUs */
/* Combined flags. */
#define MACHINE_LPT           (MACHINE_LPT - PRI | MACHINE_LPT_SEC | MACHINE_LPT_TER | MACHINE_LPT_QUA)
#define MACHINE_UART          (MACHINE_UART_PRI | MACHINE_UART_SEC | MACHINE_UART_TER | MACHINE_UART_QUA)
...
#define MACHINE_HDC        (MACHINE_MFM | MACHINE_XTA | MACHINE_ESDI | MACHINE_IDE_QUAD | MACHINE_SCSI | MACHINE_USB)
...
#define MACHINE_DMA_JUMPERS_MASK (MACHINE_DMA_0 | MACHINE_DMA_1 | MACHINE_DMA_2 | MACHINE_DMA_3 | MACHINE_DMA_DISABLED | MACHINE_DMA_5 | MACHINE_DMA_6 | MACHINE_DMA_7)
